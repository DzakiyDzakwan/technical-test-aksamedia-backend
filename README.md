...
```
git clone https://github.com/DzakiyDzakwan/technical-test-aksamedia-backend.git
```
...
-   Atur Environment dengan cara mengcopy file `.env.example` menjadi `.env`
...
-   Lakukan migrasi dan seeder database
